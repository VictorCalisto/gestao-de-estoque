...
class ClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente" do
    assert_difference("Cliente.count") do
      post clientes_url, params: { cliente: { contato: @cliente.contato, nome: @cliente.nome } }
    end
  ...
  test "should update cliente" do
    patch cliente_url(@cliente), params: { cliente: { contato: @cliente.contato, nome: @cliente.nome } }
