...
class FornecedoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference("Fornecedor.count") do
      post fornecedores_url, params: { fornecedor: { contato: @fornecedor.contato, nome: @fornecedor.nome } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { contato: @fornecedor.contato, nome: @fornecedor.nome } }
