...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference("Estoque.count") do
      post estoques_url, params: { estoque: { produto_id: @estoque.produto_id, quantidade: @estoque.quantidade } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { produto_id: @estoque.produto_id, quantidade: @estoque.quantidade } }
